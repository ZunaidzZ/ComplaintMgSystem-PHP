<?php
 $web_name = "Student Complain Management System";
 ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="animated fadeIn">
    <header class="custom_header">
        ...
        <h1>Students Complaint Management System</h1>
        <p>Post your problems and comments here about any dissasatisfaction about your University Campus!</p>
    </header>
    ...
    <div class="col-lg-12"><!--col-lg-12-->
      ...
      <div class="container"><!--col-lg-12-->
          ...
          <div class="process"></div>
            ...
            <p>We aim to provide an excellent and consistent service to all our students through our promise. If you aren’t satisfied with any aspect of our service, let us know so we can resolve the matter as quickly as possible.<br><br>The complaints procedure is set out in 3 stages below.</p>
            ...
            <p>You can complain directly to the person you have been dealing with. Complaints are often sorted out
              ...
              If you don’t know who to contact, or you have a name but no telephone number, then call our enquiries team on 01777591744.<br>
